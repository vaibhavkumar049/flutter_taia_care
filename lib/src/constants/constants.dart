class Constant {
  ...
  static const String YOURDOCTOR = "yourdoctor";
  ...
  static const String ROBOTO_MEDIUM = 'RobotoMedium';
  static const String ROBOTO_BOLD = 'RobotoBold';

  //for localization
  static const String LANG_GERMAN = 'de';
